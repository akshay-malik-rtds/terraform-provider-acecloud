...
func (r *vpcResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	// Follow-up Read to get accurate state (the create response may return
	// stale values for some fields, e.g. timestamps).
...
func (r *vpcResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	// Follow-up Read to get accurate state (the update response may be stale
	// for some computed fields and does not include reliable subnet data).
...
func (r *vpcResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	// VPC deletion may fail transiently when ports from recently-destroyed
	// sub-resources (LBs, instances, router interfaces) haven't fully
	// drained yet. Retry with "ports still in use" as a retryable pattern.
