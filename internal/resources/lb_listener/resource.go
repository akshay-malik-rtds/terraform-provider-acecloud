...
func buildCreateRequest(plan *lbListenerResourceModel) listenerCreateRequest {
	return listenerCreateRequest{
...
func mapAPIResponseToState(model *lbListenerResourceModel, apiResp *listenerAPIResponse) {
...
func (r *lbListenerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	mapAPIResponseToState(&state, listener)
