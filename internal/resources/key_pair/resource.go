...
func (r *keyPairResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	// public_key: the API returns this field as `publicKey` (camelCase).
	// Only mirror the API value into state when the user originally provided
	// a public_key in their config. For backend-generated keypairs, the API
	// returns a placeholder string which would otherwise drift against an
