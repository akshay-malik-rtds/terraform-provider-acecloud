...
- `availability_zone` (String) Availability zone for the instance. Uses the default zone if omitted.
- `billing_type` (String) Billing type for the instance flavor. Valid: hourly, monthly, quarterly, half-yearly, yearly. Defaults to 'monthly' (consistent with UI).
- `config_drive` (Boolean) Whether to attach a config drive.
...
- `server_group_id` (String) UUID of the server group to place this instance in.
- `tags` (List of String) List of tags to attach to the instance.
